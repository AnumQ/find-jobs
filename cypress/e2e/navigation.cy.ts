...
context("Navigation", () => {
  ...
  it("Navigates to the 'About' page successfully", () => {
    cy.get('[data-cy="aboutUsLink"]').click();
    cy.location("pathname").should("eq", "/about");
  });

  it("Navigates to the 'Advice' page successfully", () => {
  ...
  it("Navigates to the FAQ successfully", () => {
  ...
  it("Navigates to the 'CV Tips' page successfully", () => {
